<!-- src/lib/components/settings/MintListItem.svelte -->
<script lang="ts">
	import { Button } from '$lib/components/ui/button';
	import { Ellipsis, AlertTriangle } from 'lucide-svelte';
	import { removeMint, setAsMainMint, addMint } from '$lib/client/stores/wallet';
	import {
		Dialog,
		DialogContent,
		DialogDescription,
...
>
	<div class="flex items-center gap-2 overflow-hidden">
		{#if !mint.isRegistered}
			<AlertTriangle class="h-4 w-4 flex-shrink-0 text-amber-500" />
		{/if}
