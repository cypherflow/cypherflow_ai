<!-- src/lib/components/nostr/NostrReceiveView.svelte -->
<script lang="ts">
	...
	import { wallet, createDeposit, receiveToken, addMint } from '$lib/client/stores/wallet';
	import {
		Copy,
		LoaderCircle,
		AlertCircle,
	...
	import LnQrCode from '$lib/components/qr-codes/ln-qr-code.svelte';
	import { pasteFromClipboard, copyToClipboard } from '$lib/utils';
