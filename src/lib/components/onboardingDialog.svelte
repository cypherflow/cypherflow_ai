...
>
	<Dialog.Content class="sm:max-w-md md:max-w-lg">
		{#if currentStep === 0}
			<Dialog.Header>
				<Dialog.Title class="text-center text-xl font-bold">Welcome to {appName}!</Dialog.Title>
			</Dialog.Header>
				...
				<ul class="space-y-6">
					<li class="flex items-start gap-3">
						...
						<div>
							...
							<p class="text-sm text-muted-foreground">
								Access the latest AI models including open source options with tiny Bitcoin payments
								for each response—simple, private, and no KYC required.
							</p>
						</div>
					</li>
					...
					<li class="flex items-start gap-3">
						...
						<div>
							...
							<p class="text-sm text-muted-foreground">
								A fully functional Bitcoin wallet for instant and private transactions. Send and
								receive payments with Lightning and Ecash.
							</p>
						</div>
					</li>
					...
					<li class="flex items-start gap-3">
						...
						<div>
							...
							<p class="text-sm text-muted-foreground">
								Chat without revealing your identity. Your conversations are encrypted and follow
		...
		{:else if currentStep === 1}
			<Dialog.Header>
				<Dialog.Title class="text-center text-xl font-bold">How {appName} Works</Dialog.Title>
			</Dialog.Header>
			...
			<div class="py-6">
				<ul class="space-y-5">
					<li class="flex items-start gap-3">
						...
						<div>
							...
							<p class="text-sm text-muted-foreground">
								Add Bitcoin via Lightning or Ecash. Your funds are available throught any NIP-60
								Ecash Wallet.
							</p>
						</div>
					</li>
					...
					<li class="flex items-start gap-3">
						...
						<div>
							...
							<p class="text-sm text-muted-foreground">
								Select from state-of-the-art models like Claude, GPT-4, and open source
								alternatives. Each message costs only a few sats.
							</p>
						</div>
					</li>
					...
					<li class="flex items-start gap-3">
						...
						<div>
							...
							<p class="text-sm text-muted-foreground">
								Tiny Bitcoin payments sent per message, with no identity tracking or subscription
								fees.
							</p>
						</div>
					</li>
				...
				<div class="mt-6 flex items-start gap-3">
					...
					<p class="text-xs text-muted-foreground">
						For enhanced privacy and control, you can add your preferred Nostr relays and Ecash
						mints at any time.
					</p>
				</div>
			</div>
		...
		{:else if currentStep === 2}
			<Dialog.Header>
				<Dialog.Title class="text-center text-xl font-bold">Choose how to get started</Dialog.Title>
			</Dialog.Header>

			<div class="max-w-full space-y-4 overflow-hidden py-6">
				<!-- Generate New Account - Primary action -->
				<Button
					variant="default"
					class="h-auto w-full max-w-full flex-col items-start justify-start gap-1 p-4 text-left"
				...
				>
					...
					<p class="break-words pl-6 text-sm text-primary-foreground/80">
						Generate a new key and get started right away.
					</p>
				</Button>
				...
				>
					...
					<p class="break-words pl-6 text-sm text-muted-foreground">
						Already using {appName}? Sync with your device
					</p>
				</Button>
				...
				<div class="relative my-4">
					...
					<div class="relative flex justify-center text-xs uppercase">
						<span class="bg-background px-2 text-muted-foreground"
							>Or use existing Nostr Identity</span
						>
					</div>
				</div>
				...
				>
					...
					<p class="break-words pl-6 text-sm text-muted-foreground">
						Connect using your browser's Nostr extension.
					</p>
				</Button>
